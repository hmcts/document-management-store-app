...
public class AuditedStoredDocumentBatchOperationsServiceTests {
    ...
    public void testDeleteNotDeleted() {
        ...
        Mockito.verify(auditEntryService, Mockito.times(1))
            .createAndSaveEntry(storedDocument, AuditActions.HARD_DELETED, service.getBatchAuditUserName());
    }
    ...
    public void testDeleteAll() {
        ...
        Mockito.verify(auditEntryService, Mockito.times(1))
            .createAndSaveEntry(storedDocument2, AuditActions.HARD_DELETED, service.getBatchAuditUserName());
    }
}
