...
@Repository
public interface StoredDocumentAuditEntryRepository extends
    PagingAndSortingRepository<StoredDocumentAuditEntry, UUID>, CrudRepository<StoredDocumentAuditEntry, UUID> {
