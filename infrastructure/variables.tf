...
variable "s2s_names_whitelist" {
  default = "em_api,em_gw,ccd_gw,ccd_data,sscs,divorce_document_upload,divorce_frontend,divorce_document_generator,probate_backend,finrem_backend,jui_webapp,pui_webapp,cmc_claim_store,bulk_scan_processor,em_npa_app,bulk_scan_orchestrator,fpl_case_service"
}
